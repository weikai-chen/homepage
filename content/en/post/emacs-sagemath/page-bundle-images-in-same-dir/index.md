...
{{< figure src="screen-sage-shell.png" caption="Figure 1: Sage shell in Emacs using sage-shell-mode" >}}

{{< figure src="screen-sage-blocks.png" caption="Figure 2: Script blocks using ob-sagemath" >}}
