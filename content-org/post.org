...
** TODO Using Snippets in Org :Emacs:org:Snippets:tools:
:PROPERTIES:
:EXPORT_HUGO_SECTION: en/post/using-snippets
:EXPORT_FILE_NAME: index
:EXPORT_DATE: 2020-04-07
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :Using the yasnippet to write template for org exporting
:END:
